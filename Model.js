...
STRINGS[JALALI] = {
  ...
  caldavOption: "CalDAV",
  googleOption: "گوگل",
  caldavHint: "سرور ایمیل سازمانی‌تان، نکست‌کلاد، رادیکاله، فست‌میل، آی‌کلاد و بیشتر سرورهای دیگر.",
  serverLabel: "نشانی سرور",
  serverHint: "ریشهٔ سرور ایمیل — همان هاستی که IMAP و وبمیل‌تان روی آن است؛ نه نشانی خودِ تقویم.",
...
STRINGS[GREGORIAN] = {
  ...
  switchTo: "Switch to the %1 calendar",
  ...
  caldavOption: "CalDAV",
  googleOption: "Google",
  caldavHint: "Your company mail server, Nextcloud, Radicale, Fastmail, iCloud, and most others.",
  serverLabel: "Server URL",
  serverHint: "The mail server root -- the same host as your IMAP account and webmail, not a calendar URL.",
